...
// Jiang Xing Kai’s iPhone phone ssid
//const char* ssid = "Jiang Xing Kai’s iPhone";
//const char* password = "1234567890";

 const char* ssid = "JTHUAWEI-P9UDFQ_HiLink";
 const char* password = "Desktop1";
...
// This is your Static IP for JTHUAWEI
IPAddress local_IP(192, 168, 3, 100);
// Gateway IP address for JTHUAWEI
